...
class MvCamera():
    ...
    def MV_CC_EnumDevicesEx(nTLayerType, stDevList, strManufacturerName):
        ...
        # C原型:int __stdcall MV_CC_EnumDevicesEx(IN unsigned int nTLayerType,
        # IN OUT MV_CC_DEVICE_INFO_LIST* pstDevList, IN const char* strManufacturerName);
    ...
    def MV_CC_RegisterImageCallBackForRGB(self, CallBackFun, pUser):
        ...
        # C原型:int MV_CC_RegisterImageCallBackForRGB(void* handle, void(* cbOutput)
        # (unsigned char * pData, MV_FRAME_OUT_INFO_EX* pFrameInfo, void* pUser),void* pUser);
    ...
    def MV_CC_RegisterImageCallBackForBGR(self, CallBackFun, pUser):
        ...
        # C原型:int MV_CC_RegisterImageCallBackForBGR(void* handle, void(* cbOutput)
        # (unsigned char * pData, MV_FRAME_OUT_INFO_EX* pFrameInfo, void* pUser),void* pUser);
    ...
    def MV_CC_GetImageForRGB(self, pData, nDataSize, stFrameInfo, nMsec):
        ...
        # C原型:int MV_CC_GetImageForRGB(IN void* handle, IN OUT unsigned char * pData ,
        # IN unsigned int nDataSize, IN OUT MV_FRAME_OUT_INFO_EX* pstFrameInfo, int nMsec);
    ...
    def MV_CC_GetImageForBGR(self, pData, nDataSize, stFrameInfo, nMsec):
        ...
        # C原型:int MV_CC_GetImageForBGR(IN void* handle, IN OUT unsigned char * pData ,
        # IN unsigned int nDataSize, IN OUT MV_FRAME_OUT_INFO_EX* pstFrameInfo, int nMsec);
    ...
    # ch:显示一帧图像 | en:Get a frame of an image using an internal cache
    # (Cannot be used together with the interface of MV_CC_Display)
    ...
    # Greater than or equal to 1, to be called before the capture
    ...
    def MV_CC_RegisterAllEventCallBack(self, EventCallBackFun, pUser):
        ...
        # C原型:int MV_CC_RegisterAllEventCallBack(void* handle, void(__stdcall* cbEvent)
